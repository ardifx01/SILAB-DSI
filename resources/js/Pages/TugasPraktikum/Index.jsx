      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="lg:hidden space-y-4">
          {getCurrentTugasData().length === 0 ? (
            ...
            getCurrentTugasData().map((tugasItem, index) => (
              <div key={tugasItem.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex justify-between items-start mb-3">
                  ...
                  {canManage && (
                    <div className="flex space-x-2 ml-4">
                      ...
                      <button
                        onClick={() => openDeleteModal(tugasItem)}
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <span className="text-gray-600 font-medium">Deskripsi:</span>
                    <p className="text-gray-800 mt-1">{tugasItem.deskripsi || '-'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 mt-1">{formatDate(tugasItem.deadline)}</p>
                  </div>
