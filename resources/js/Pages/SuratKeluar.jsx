...
export default function SuratKeluar({ flash }) {
    // Sample data untuk demonstrasi
    const [suratKeluar, setSuratKeluar] = useState([
        {
            id: 1,
            nomor_surat: 'XXX/XXX/XXX',
            tanggal_surat: '2025-03-18',
            judul: 'Permohonan Izin Kegiatan Laboratorium',
            pengirim: 'Kepala Laboratorium',
            penerima: 'Dekan Fakultas',
            file: 'surat-keluar-1.pdf',
        },
        {
            id: 2,
            nomor_surat: 'XXX/XXX/XXX',
            tanggal_surat: '2025-03-12',
            judul: 'Laporan Kerusakan Alat Laboratorium',
            pengirim: 'Koordinator Laboratorium',
            penerima: 'Bagian Sarana Prasarana',
            file: 'surat-keluar-2.pdf',
        },
        {
            id: 3,
            nomor_surat: 'XXX/XXX/XXX',
            tanggal_surat: '2025-03-07',
            judul: 'Undangan Rapat Koordinasi Asisten Praktikum',
            pengirim: 'Koordinator Praktikum',
            penerima: 'Seluruh Asisten Praktikum',
            file: 'surat-keluar-3.pdf',
        },
    ]);
    ...
    const handleDelete = (id) => {
        if (confirm('Apakah Anda yakin ingin menghapus surat ini?')) {
            ...
            const updatedSuratList = suratKeluar.filter(surat => surat.id !== id);
            setSuratKeluar(updatedSuratList);
    ...
    return (
        <DashboardLayout>
            ...
            <div className="py-4">
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-1 text-gray-500 md:ml-2">Surat Keluar</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <h1 className="text-2xl font-semibold text-gray-800 mb-6">Surat Keluar</h1>
                        ...
                        <div className="p-4 overflow-y-auto">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{selectedSurat.penerima}</p>
                                </div>
                                <div className="md:col-span-2">
                                    <p className="text-sm text-gray-500">Judul/Perihal</p>
